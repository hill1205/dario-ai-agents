...
function notionPageToEntry(page) {
  ...
  return {
    ...
    linkedin_referente: p["Referente LinkedIn"]?.url || "",
  ...
  try {
    ...
    for (const entry of entries) {
      const properties = {
        ...
        "LinkedIn":  entry.linkedin  ? { url: entry.linkedin }  : { url: null },
        "Referente LinkedIn": entry.linkedin_referente ? { url: entry.linkedin_referente } : { url: null },
